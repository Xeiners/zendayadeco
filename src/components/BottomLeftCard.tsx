  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-serif text-sage tracking-tight">
          150+
        </span>
        <span className="text-[10px] md:text-[12px] font-sans font-normal text-sage/60 uppercase tracking-wider">
          Projets réalisés
        </span>
      </div>
      ...
      >
        <div className="bg-sage/10 p-1 rounded-full flex items-center justify-center">
          <ArrowUpRight className="w-4 h-4 text-sage" />
        </div>
        <span className="text-[14px] font-sans font-normal text-sage">Voir le Showroom</span>
      </motion.a>
    </motion.div>
  );
}